...
class DataPenindakanModel extends Model
{
    ...
    public function getDataPenindakanStatusBAPTerbayar($ukpd_id)
    {
        if ($ukpd_id == null) {
            return $this->table($this->table)
                ->select($this->fieldTable)
    ...
    public function totalPenderekan($ukpd_id)
    {
        if ($ukpd_id == null) {
            return $this->table($this->table)
                ->join('ukpd_table', 'ukpd_table.id = data_penindakan_table.ukpd_id', 'left')
    ...
    public function totalPenderekanPerhari($tanggal_pelanggaran, $ukpd_id)
    {
        if ($ukpd_id == null) {
            return $this->table($this->table)
                ->select($this->fieldTable)
    ...
    public function totalPenderekanTerbayarDetail($ukpd_id)
    {
        if ($ukpd_id == null) {
            return $this->table($this->table)
                ->select($this->fieldTable)
    ...
    public function totalPenderekanTerbayarDetailPerhari($tanggal_pelanggaran, $ukpd_id)
    {
        if ($ukpd_id == null) {
            return $this->table($this->table)
                ->select($this->dataTable)
    ...
    public function totalPenderekanBelumTerbayarDetail($ukpd_id)
    {
        if ($ukpd_id == null) {
            return $this->table($this->table)
                ->select($this->dataTable)
    ...
    public function totalPenderekanBelumTerbayarDetailPerhari($tanggal_pelanggaran, $ukpd_id)
    {
        if ($ukpd_id == null) {
            return $this->table($this->table)
                ->select($this->dataTable)
    ...
    public function totalPenderekanSelesai($ukpd_id)
    {
        if ($ukpd_id == null) {
            return $this->table($this->table)
                ->select($this->dataTable)
    ...
    public function totalPenderekanSelesaiPerhari($tanggal_pelanggaran, $ukpd_id)
    {
        if ($ukpd_id == null) {
            return $this->table($this->table)
                ->select($this->dataTable)
