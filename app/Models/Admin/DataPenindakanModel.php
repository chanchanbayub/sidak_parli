...
class DataPenindakanModel extends Model
{
    ...
    protected $allowedFields    = ['ukpd_id', 'ppns_id', 'spt_id', 'unit_id', 'jenis_penindakan_id', 'bap_id', 'jenis_pelanggaran_id', 'tanggal_pelanggaran', 'jam_pelanggaran', 'tempat_penyimpanan_id'];
