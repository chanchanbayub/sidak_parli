...
class DataPenindakanModel extends Model
{
    ...
    protected $allowedFields    = ['ukpd_id', 'ppns_id', 'spt_id', 'unit_id', 'jenis_penindakan_id', 'bap_id', 'jenis_pelanggaran_id', 'tanggal_pelanggaran', 'jam_pelanggaran', 'tempat_penyimpanan_id', 'foto'];
    ...
    'data_penindakan_table.id, data_penindakan_table.ukpd_id, data_penindakan_table.ppns_id, data_penindakan_table.spt_id, data_penindakan_table.unit_id,data_penindakan_table.jenis_penindakan_id,data_penindakan_table.bap_id, data_penindakan_table.jenis_pelanggaran_id,data_penindakan_table.tanggal_pelanggaran, data_penindakan_table.jam_pelanggaran, data_penindakan_table.tempat_penyimpanan_id,
    ukpd_table.ukpd,
    status_penderekan_table.status_penderekan,
    bap_table.nomor_bap, bap_table.status_bap_id,
    ...
    public function getDataPenindakanWithNoKendaraan($nomor_kendaraan)
    {
        return $this->table($this->table)
            ...
            ->join('unit_regu_table', 'unit_regu_table.id = data_penindakan_table.unit_id', 'left')
            ...
            ->join('surat_pengeluaran_table', 'surat_pengeluaran_table.bap_id = bap_table.id', 'left')
            ->where(["data_kendaraan_table.nomor_kendaraan" => $nomor_kendaraan])
            ->orderBy('data_penindakan_table.id desc')
            ->get()->getRowObject();
    }

    public function getDataPenindakan($unit_id, $ukpd_id)
    {
        return $this->table($this->table)
            ->select($this->fieldTable)
            ->join('ukpd_table', 'ukpd_table.id = data_penindakan_table.ukpd_id', 'left')
            ...
            ->join('tempat_penyimpanan_table', 'tempat_penyimpanan_table.id = data_penindakan_table.tempat_penyimpanan_id', 'left')
            ->join('jenis_pelanggaran_table', 'jenis_pelanggaran_table.id = data_penindakan_table.jenis_pelanggaran_id', 'left')
            ->join('unit_regu_table', 'unit_regu_table.id = data_penindakan_table.unit_id')
            ->join('data_pelanggar_table', 'data_pelanggar_table.bap_id = data_penindakan_table.bap_id', 'left')
            ->join('kartu_identitas_table', 'kartu_identitas_table.id = data_pelanggar_table.kartu_identitas_id', 'left')
    ...
    public function getDataPenindakanPenderekan($unit_id, $ukpd_id)
    {
        return $this->table($this->table)
            ...
            ukpd_table.ukpd, bap_table.nomor_bap, bap_table.status_bap_id,data_kendaraan_table.nomor_kendaraan, jenis_penindakan_table.jenis_penindakan, tempat_penyimpanan_table.tempat_penyimpanan, status_penderekan_table.status_penderekan')
    ...
    public function totalPenderekan($tanggal_pelanggaran, $unit_id)
    {
        return $this->table($this->table)
    ...
    public function totalPenderekanTerbayarDetail($tanggal_pelanggaran, $unit_id)
    {
        return $this->table($this->table)
            ->select($this->fieldTable)
            ->join('ukpd_table', 'ukpd_table.id = data_penindakan_table.ukpd_id', 'left')
            ...
            ->where(["data_penindakan_table.unit_id" => $unit_id])
            ->get()->getResultObject();
    }

    public function totalPenderekanBelumTerbayarDetail($tanggal_pelanggaran, $unit_id)
    {
        return $this->table($this->table)
            ->select($this->fieldTable)
            ->join('ukpd_table', 'ukpd_table.id = data_penindakan_table.ukpd_id', 'left')
    ...
    public function totalPenderekanSelesai($tanggal_pelanggaran, $unit_id)
    {
        return $this->table($this->table)
            ->select($this->fieldTable)
            ->join('ukpd_table', 'ukpd_table.id = data_penindakan_table.ukpd_id', 'left')
