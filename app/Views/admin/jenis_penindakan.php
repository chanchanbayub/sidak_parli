    ...
    <div class="pagetitle">
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="/admin/jenis_penindakan">JENIS PENINDAKAN</a></li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">JENIS PENINDAKAN</h5>
                        <p>
                            <button class="btn btn-outline-secondary btn-sm" data-bs-toggle="modal" data-bs-target="#smallModal">Tambah Penindakan</button>
                        </p>
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table datatable">
                                <thead>
                                    <tr>
                                        <th scope="col">#</th>
                                        <th scope="col">Nama Penindakan</th>
    ...
    <div class="modal-dialog modal-dialog-scrollable modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Tambah Jenis Penindakan</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form id="tambah_penindakan" autocomplete="off">
                    <?= csrf_field(); ?>
                    <div class="form-group">
                        <label for="jenis_penindakan" class="col-form-label">Jenis Penindakan:</label>
                        <input type="text" class="form-control" id="jenis_penindakan" name="jenis_penindakan" placeholder="cth : penderekan">
            ...
            success: function(response) {
                ...
                if (response.error) {
                    if (response.error.jenis_penindakan) {
                        ...
                        $(".error-penindakan").html(response.error.jenis_penindakan);
                    } else {
                        $("#jenis_penindakan").removeClass('is-invalid');
                        $(".error-penindakan").html('');
                    }
