    ...
    <div class="pagetitle">
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="/admin/jenis_spk">Jenis SPK</a></li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
            ...
            <div class="modal-body">
                <form id="addForm" autocomplete="off">
                    ...
                    <div class="form-group">
                        <label for="jenis_spk" class="col-form-label">Jenis SPK:</label>
                        <input type="text" class="form-control" id="jenis_spk" name="jenis_spk" placeholder="cth: Jenis SPK ">
                        <div class="invalid-feedback error-spk">
            ...
            <div class="modal-body">
                <form id="formEdit" autocomplete="off">
                    ...
                    <div class="form-group">
                        ...
                        <label for="jenis_spk" class="col-form-label">Jenis SPK:</label>
                        <input type="text" class="form-control" id="jenis_spk_edit" name="jenis_spk">
                        <div class="invalid-feedback error-spk-edit">
...
<script>
    $("#addForm").submit(function(e) {
        e.preventDefault();
        let jenis_spk = $('#jenis_spk').val();

        $.ajax({
            url: '/admin/jenis_spk/insert',
            method: 'post',
            dataType: 'JSON',
            data: {
                jenis_spk: jenis_spk,
            ...
            success: function(response) {
                ...
                if (response.error) {
                    if (response.error.jenis_spk) {
                        $("#jenis_spk").addClass('is-invalid');
                        $(".error-spk").html(response.error.jenis_spk);
                    } else {
                        $("#jenis_spk").removeClass('is-invalid');
                        $(".error-spk").html('');
                    }
    ...
    $(document).on('click', "#edit", function(e) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $("#jenis_spk_edit").val(response.jenis_spk);
            }
        });
    });
    ...
    $("#formEdit").submit(function(e) {
        e.preventDefault();
        let id = $('#id_edit').val();
        let jenis_spk = $('#jenis_spk_edit').val();
        $.ajax({
            url: '/admin/jenis_spk/update',
            method: 'post',
            dataType: 'JSON',
            data: {
                id: id,
            ...
            success: function(response) {
                ...
                if (response.error) {
                    if (response.error.jenis_spk) {
                        $("#jenis_spk_edit").addClass('is-invalid');
                        $(".error-spk-edit").html(response.error.jenis_spk);
                    } else {
                        $("#jenis_spk_edit").removeClass('is-invalid');
                        $(".error-spk-edit").html('');
                    }
                } else {
                    Swal.fire({
