    ...
    <div class="pagetitle">
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="/petugas/angkut_motor"><?= $title ?></a></li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
                                            ...
                                            <td>
                                                <div class="btn-group-sm" role="group">
                                                    ...
                                                    <ul class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                                        ...
                                                        <?php endif; ?>
                                                        <a class="dropdown-item btn-sm" href="/petugas/angkut_motor/getDetail/<?= $data->id ?>" id="view">
...
<script>
    ...
    $(document).on('change', "#ukpd_id", function(e) {
        ...
        $.ajax({
            url: '/petugas/angkut_motor/getUnit',
            method: 'get',
            dataType: 'JSON',
            data: {
                ukpd_id: ukpd_id,
    ...
    $(document).on('change', "#provinsi_id", function(e) {
        ...
        $.ajax({
            url: '/petugas/angkut_motor/getKota',
            method: 'get',
            dataType: 'JSON',
            data: {
    ...
    $(document).on('change', "#kota_id", function(e) {
        ...
        $.ajax({
            url: '/petugas/angkut_motor/getKecamatan',
            method: 'get',
            dataType: 'JSON',
            data: {
                kota_id: kota_id,
    ...
    $("#form_add").submit(function(e) {
        ...
        $.ajax({
            url: '/petugas/angkut_motor/insert',
            data: formData,
            dataType: 'json',
    ...
    $("#delete_form").submit(function(e) {
        ...
        $.ajax({
            url: '/petugas/angkut_motor/delete',
            method: 'post',
            dataType: 'JSON',
            data: {
                id: id,
    ...
    $("#edit_form").submit(function(e) {
        ...
        $.ajax({
            url: '/petugas/angkut_motor/update',
            data: formData,
            dataType: 'json',
            enctype: 'multipart/form-data',
            type: 'POST',
