...
use App\Models\Petugas\AngkutMotorModel;
...
class AngkutMotor extends BaseController
{
    ...
    public function index()
    {
        ...
        $angkut_motor = $this->angkutMotorModel->getAngkutMotor(session()->get('ukpd_id'), session()->get('unit_id'));
        ...
        return view('petugas/angkut_motor', $data);
    }
    ...
    public function getDetail($id)
    {
        ...
        return view('petugas/detail_angkut_motor', $data);
    }
